...
def test_execute_deletes_groups_by_ids():
    # 目的: test_execute_deletes_groups_by_ids の挙動を検証する。
    # 入力: なし
    ...
    # Act
    use_case.execute([g1._id])

    # Assert
    remaining = group_repository.find()
...
def test_execute_with_empty_ids_does_nothing():
    ...
    # reply_service: なし
    # DB操作: group_repository.create(Group(line_group_id="G1")); remaining = group_repository.find()
    # Arrange
